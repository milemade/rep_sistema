...
function abrir() {		
	...
	if(document.getElementById('tipo_informe').value==1) {
		...
		imprimir_inf("con_carte_factu_cli_facturas.php",''+cod_bodega+'&codigo_bodega='+cod_bodega,'mediano');
	...
	if(document.getElementById('tipo_informe').value==2) {
		...
		imprimir_inf("con_carte_factu_cli_abonos.php",''+cod_bodega+'&codigo_bodega='+cod_bodega,'mediano');
	...
	if(document.getElementById('tipo_informe').value==3) {
		...
		imprimir_inf("con_carte_factu_cli.php",''+cod_bodega+'&codigo_bodega='+cod_bodega,'mediano');
