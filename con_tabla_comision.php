...
if($eliminacion==1) {//confirmacion de insercion  
	$error=eliminar("m_comisiones",$eli_codigo,"cod_tabla");
	if ($error >=1)
...
$cantidad_paginas=paginar("SELECT cod_tabla , nom_tabla  FROM m_comisiones   $where");
...
<tr>
<td valign="top" >
<form id="forma_total" name="forma_total" method="post" action="man_tabla_comision.php">
                  <table width="624" border="0" cellspacing="0" cellpadding="0" align="center" >
                    <tr>
                      <td bgcolor="#E9E9E9"><table width="624" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="19"> 
						  <? if ($insertar==1) {?>
					  	  <img src="imagenes/page.png" width="16" height="16"  alt="Nuevo Registro" style="cursor:pointer" onClick="location.href='man_tabla_comision.php?codigo=0&editar=<?=$editar?>&insertar=<?=$insertar?>&eliminar=<?=$eliminar?>'"/>
					  	  <? } ?></td>
                          ...
                          <td width="160" valign="middle"><select name="campos" class="textfieldlista" id="campos" >
                            ...
                            <option value="nom_tabla">Nombre Tabla</option>
                    ...
                    <tr>
                      <td><table width="624" border="0"  cellpadding="0">
						...
						<? 
						echo "<tr style='display:none'><td ><form name='forma_0' action='man_tabla_comision.php'>";
						echo "  </form> </td></tr>  ";						  
						$estilo="ctablablanc";
						$estilo="ctablagris";
						$sql="SELECT cod_tabla,nom_tabla  FROM m_comisiones   $where $paginar";
						...
						while($db->next_row()) {
							...
							echo "<tr class='$estilo' $cambio_celda> <form name='forma_$db->cod_tabla' action='man_tabla_comision.php'>  ";
                          	echo "<td >$db->nom_tabla </td>";
                            echo "<td aling='center' >"; 
							echo 	"<table width='100%' border='0' cellspacing='0' cellpadding='0'>";
                            echo 	" <tr>  <td align='center'> <input type='hidden' name='codigo' value='$db->cod_tabla'>";
							if ($editar==1)
							 	echo "<img src='imagenes/icoeditar.gif' alt='Editar Registro' width='16' height='16' style='cursor:pointer'  onclick='document.forma_$db->cod_tabla.submit()'/></td>";
							else 
								echo "<img src='imagenes/e_icoeditar.gif' width='16' height='16'  /></td>";
                            echo 	"<td align='center'>";
							if ($eliminar==1)
								echo"<img src='imagenes/icoeliminar.gif' width='16' alt='Eliminar Registro' height='16' style='cursor:pointer' onclick=confirmar($db->cod_tabla) /></td> ";
							else
...
<form name="forma" method="post" action="con_tabla_comision.php">
