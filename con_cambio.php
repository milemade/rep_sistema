...
$sql="select * , bodega1.nom_bod as nom_cliente from m_factura left join usuario on usuario.cod_usu=m_factura.cod_usu
left join bodega1 on bodega1.cod_bod=m_factura.cod_cli left join bodega on bodega.cod_bod =m_factura.cod_bod $where ORDER BY cod_fac  DESC ";
//exit;
