...
if($eliminacion==1) {//confirmacion de insercion  
	...
	$sql="select *,(select cod_bod from m_entrada where cod_ment=$eli_codigo) as bodega from  d_entrada where cod_ment_dent=$eli_codigo";
	$dbser= new  Database();	
	$dbser->query($sql);
...
$sql="SELECT * FROM m_entrada INNER JOIN bodega ON m_entrada.cod_bod=bodega.cod_bod INNER JOIN usuario ON m_entrada.usu_ment  =usuario.cod_usu  $where ORDER BY cod_ment DESC ";
