...
function abrir() {		
	...
	if(document.getElementById('tipo_informe').value==1) {
		...
		imprimir_inf("con_carte_factu_prove_facturas.php",''+cod_bodega+'&codigo_bodega='+cod_bodega,'mediano');
	}
	if(document.getElementById('tipo_informe').value==2) {
		cod_bodega= document.getElementById('cliente').value;	
		imprimir_inf("con_abono_prove.php",''+cod_bodega+'&codigo_bodega='+cod_bodega,'mediano');
	}
	if(document.getElementById('tipo_informe').value==3) {
		cod_bodega= document.getElementById('cliente').value;	
		imprimir_inf("con_carte_factu_prove.php",''+cod_bodega+'&codigo_bodega='+cod_bodega,'mediano');
	}
...
<form id="forma_total" name="forma_total" method="post" action="formatos/ver_traza.php">
                  <table width="624" border="0" cellspacing="0" cellpadding="0" align="center" >
                    ...
                    <tr>
                      <td>
					  <table width="557" border="0"  cellpadding="0" align="center">
                        <tr>
						  <td width="301"  class="ctablasup" >OPCION POR PROVEEDOR</td>
	...
	// combo_sql("cliente","proveedor","cod_pro","nom_pro","",""); 
		?>
