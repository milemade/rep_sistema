...
function abrir() {		
	...
	imprimir_inf("consulta_existencias_admin.php",'0&codigo='+cod_bodega,'mediano');
}
...
<form id="forma_total" name="forma_total" method="post" action="formatos/ver_traza.php">
                  <table width="624" border="0" cellspacing="0" cellpadding="0" align="center" >
                    ...
                    <tr>
                      <td>
					  <table width="517" border="0"  cellpadding="0" align="center">
                        <tr>
						  <td width="330"  class="ctablasup" >OPCION POR BODEGA </td>
						  <td  class="ctablasup"  width="156">INFORME</td>
                        </tr>
						<? 
						...
						?>
							      ...
							      <td >Bodega 
						        <? combo_evento("bodega","bodega","cod_bod","nom_bod"," ","  ", "nom_bod"); ?></td>
							        <td aling='center' >
