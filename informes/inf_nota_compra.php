...
$sql ="select * 
	 ...
	 JOIN usuario on usuario.cod_usu=notas_compra.cod_usu_notc
	 where cod_notc= '$codigo' ";	   
$db_ver->query($sql);	
if($db_ver->next_row()){ 
	...
	$numero_factura = $db_ver->fac_ment;
	$total_factura = $db_ver->total_ment;
	$valor_abono = $db_ver->sal_ant_ment;
...
function imprimir(){
 ...
 <title><?=$nombre_aplicacion?> -- NOTA COMPRA --</title>
 <style type="text/css">
<!--
		...
		<TABLE width="98%" border="1" cellpadding="0" cellspacing="0" bordercolor="#999999" >
			...
			<TR>
			  ...
			  <table width="100%" border="1" cellpadding="1" cellspacing="0" bordercolor="#333333">
			  	<tr>
			  		<td width="47%" rowspan="3"><span class="Estilo4">NOTA COMPRA<span> </td>
				...
				<tr>
			  	  ...
			  	  <td  colspan="2" class="ctablaform"><span class="textoproductos1">&nbsp;&nbsp;Usuario :<span class="textotabla01">
