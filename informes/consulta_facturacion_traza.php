...
if (!empty($codigo)) 
 ...
 $sql1 = " SELECT  a.cod_car_fac,
                  ...
                  JOIN m_factura b ON a.cod_fac = b.cod_fac
                  JOIN bodega1 c ON b.cod_cli = c.cod_bod
                  JOIN notas_ventas d ON d.cod_ven_notc = b.cod_fac
			...
			$sql = "SELECT 
				  ...
				  union
					SELECT 
					  ...
					  d.fec_notc as fecha_doc ,
					   d.val_notc as valor_decuento,
					   a.cod_car_fac AS codigo_cartera
					FROM
					  cartera_factura a
					  JOIN m_factura b ON a.cod_fac = b.cod_fac
					  JOIN bodega1 c ON b.cod_cli = c.cod_bod
					  JOIN notas_ventas d ON b.cod_fac = d.cod_ven_notc
					where a.cod_fac = $codigo_cartera_not
					ORDER BY
					  fecha_doc  ";
//echo $sql;
		$db_traza->query($sql);
