...
<title>ABONOS POR PROVEEDOR</title><table width="72%" border="1" cellpadding="2" cellspacing="1"  class="textoproductos1">
  ...
  <tr>
    <td colspan="5" class="ctablasup"> PROVEEDOR :
      <?=$nombre?></td>
  </tr>
  ...
  <?
		...
		$sql=" SELECT  * FROM   abono_pago   WHERE   abono_pago.cod_bod_Abo=$codigo ";
		...
		while($db->next_row()){
			...
			echo "<td align='center'><img src='../imagenes/mirar.png' width='16' height='16'  style=\"cursor:pointer\" onClick=\"imprimir_factura('ver_abono_pago.php',$db->cod_abo,'mediano')\" /></td>";	
			echo "</TR>	</FORM>";
