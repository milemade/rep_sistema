		...
		?>
            ...
            <td   class="botones1">Cantidad</td>
			 ...
			 $sql = " SELECT * 
				...
				LEFT JOIN peso ON peso.cod_pes=d_traslado.cod_pes_dtra  WHERE cod_mtras_dtra=$codigo  ORDER BY d_traslado.serial ";
					$db->query($sql);
					$estilo="formsleo";
					while($db->next_row()){ 	
                ...
                <tr id="fila_0"  >
                  ...
                  <td colspan="1" class="textotabla01"> &nbsp;<?=$db->serial?></td>
                  <td class="textotabla01"><div align="right"><?=number_format($db->cant_dtra,2,".",".")?></div></td>
                </tr>
