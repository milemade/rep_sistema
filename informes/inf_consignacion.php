...
//echo $codigo;
$nombre_aplicacion="INFORME CONSIGNACION EN VENTA ";
//exit;
...
<TABLE width="100%" border="0" cellspacing="0" cellpadding="0"   >
	...
	<TR>
		<TD align="center">
		<TABLE width="92%" border="1" cellpadding="0" cellspacing="0" bordercolor="#999999" >
			...
			<TR>
			  ...
			  <table width="100%" border="1" cellpadding="1" cellspacing="0" bordercolor="#333333">
			  	<tr>
				    ...
				    <td width="36%" height="22" class="ctablaform"> <span class="textoproductos1"> &nbsp;&nbsp;&nbsp;&nbsp;INFORME CONSIGNACION EN VENTA </span><span class="textoproductos1"></span>				  </td>
			  	   
			  	    <td width="46%" class="ctablaform"><span class="textoproductos1">&nbsp;&nbsp;Fecha Inical:
					<?=$fec_ini?> &nbsp;&nbsp;
			...
			<TR>
			  ...
			  <table width="100%" border="1" cellpadding="1" cellspacing="1" bordercolor="#333333" id="select_tablas" >
                <tr >
                  <td width="33%"  class="botones1">Empresa</td>
			      <td width="22%"  class="botones1">Vendedor</td>
				   <td width="19%"  class="botones1">Ruta</td>
			       <td width="12%"  class="botones1">Fecha</td>
                 
				   <td width="14%" align="center" class="botones1">Valor Consignacion</td>
                </tr>
			   ...
			   $sql = "SELECT *,
				(SELECT SUM(val_consig_dvcon) FROM d_consignacion_venta WHERE cod_mven_dvcon=cod_mven  )AS total_consignacion,(SELECT rsocial.nom_rso FROM rsocial WHERE rsocial.cod_rso=vendedor.cod_emp_ven) AS empresa
				 FROM m_venta
				 INNER JOIN  vendedor ON vendedor.cod_ven =cod_ven_mven
				 LEFT JOIN ruta ON ruta.cod_rut=m_venta.cod_rut_mven
                ...
                <tr  >
                  ...
                  <td  class="textotabla01"><div align="right">
					<?=number_format($db->total_consignacion,0,".",".")?>
                  </div></td>
                </tr>
				  
				<?
				$total+=$db->total_consignacion;
				  } 
				 ...
				 ?>
                  ...
                  <td colspan="4" class="subfongris"> <div align="right" >
                    <div align="right">Total Consignacion del Periodo:</div>
                  </div></td>
