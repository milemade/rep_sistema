...
$es_abono="si";
	...
	$sql = "select * , (select nom_usu  from usuario where cod_usu=abono_pago.cod_usu_abo) as usuario  from abono_pago where cod_abo=$codigo";
...
?>
 ...
 <title>IMPRESION ABONO PAGO</title><TABLE width="95%" border="0" cellspacing="0" cellpadding="0">
	...
	<TR>
		...
		<TABLE width="94%" border="1" cellpadding="2" cellspacing="2" >
			...
			<TR>
			  ...
			  <TD colspan="2" class='txtablas'> <? include("factura_proveedor.php") ?>	</TD>
