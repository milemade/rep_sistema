...
function abrir() {		
	...
	if(document.getElementById('fec_fin').value == ""  ||  document.getElementById('fec_ini').value==""  ||  document.getElementById('cliente').value=="") 
...

	{
		...
		var proveedor = document.getElementById('cliente').value;

		imprimir_inf("liquidacion_prove.php",'0&fec_ini='+fec_ini+'&fec_fin='+fec_fin+'&proveedor='+proveedor,'mediano');
...
<form id="forma_total" name="forma_total" method="post" action="formatos/ver_traza.php">
                  ...
                  <table width="771" border="0" cellspacing="0" cellpadding="0" align="center" >
                    ...
                    <tr>
                      ...
                      <td><table width="762" border="0"  cellpadding="0" align="center">

                        <tr>

                          <td colspan="6"  class="ctablasup" >CONSULTA LIQUIDACION </td>

                          <td  class="ctablasup"  width="82">INFORME</td>
                        ...
                        <tr>
                          ...
                          <td width="62" class="ctablablanc" >Proveedor</td>
		...
		?></td>
                          ...
                          <td width="69" class="ctablablanc" >Fecha Inicial </td>

                          <td width="156" class="ctablablanc" >
                          ...
                          <td width="64" class="ctablablanc" >Fecha Final </td>
