...
if($eliminacion==1) {//confirmacion de insercion  
	...
	$error=eliminar("d_comision",$eli_codigo,"cod_com");
...
$sql="SELECT cod_com, val_min_com, val_max_com, val_com ,cod_m_com , nom_tabla FROM d_comision INNER JOIN m_comisiones ON d_comision.cod_m_com = m_comisiones.cod_tabla $where ";
...
<form id="forma_total" name="forma_total" method="post" action="man_comision.php">
                      ...
                      <td bgcolor="#E9E9E9"><table width="624" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
						  ...
						  <? if ($insertar==1) {?>
					  	  ...
					  	  <img src="imagenes/page.png" width="16" height="16"  alt="Nuevo Registro" style="cursor:pointer" onClick="location.href='man_comision.php?codigo=0&editar=<?=$editar?>&insertar=<?=$insertar?>&eliminar=<?=$eliminar?>'"/>
                          ...
                          <td width="160" valign="middle"><select name="campos" class="textfieldlista" id="campos" >
                            ...
                            <option value="nom_tabla">Tipo</option>
                            <option value="val_min_com">Valor mínimo</option>
                            <option value="val_max_com">Valor Máximo</option>
                    ...
                    <tr>
                      ...
                      <td><table width="624" border="0"  cellpadding="0">
                        ...
                        <tr>
						  ...
						  <td  class="ctablasup">MINIMO</td>

						  <td  class="ctablasup">MAXIMO</td>
						...
						echo "<tr style='display:none'><td ><form name='forma_0' action='man_comision.php'>";
						...
						while($db->next_row()) {
							...
							echo "<tr class='$estilo' $cambio_celda> <form name='forma_$db->cod_com' action='man_comision.php'>  ";

                          	echo "<td >$db->nom_tabla</td>";

                          	echo "<td  >$db->val_min_com</td> ";

							echo "<td  >$db->val_max_com</td> ";
...
<form name="forma" method="post" action="con_comision.php">
