...
if($eliminacion==1) {//confirmacion de insercion  
	$error=eliminar("rsocial",$eli_codigo,"cod_rso");
	if ($error >=1)
...
$sql="select cod_rso,nom_rso,nit_rso  FROM rsocial  $where ";
                      ...
                      <td bgcolor="#E9E9E9"><table width="624" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
						  ...
						  <? if ($insertar==1) {?>
					  	  ...
					  	  <img src="imagenes/page.png" width="16" height="16"  alt="Nuevo Registro" style="cursor:pointer" onClick="location.href='man_rsocial.php?codigo=0&editar=<?=$editar?>&insertar=<?=$insertar?>&eliminar=<?=$eliminar?>'"/>
                      ...
                      <td><table width="624" border="0"  cellpadding="0">
						...
						while($db->next_row()) {
							...
							if ($editar==1)
							 	...
							 	echo "<img src='imagenes/icoeditar.gif' alt='Editar Registro' width='16' height='16' style='cursor:pointer'  onclick='document.forma_$db->cod_rso.submit()'/></td>";
							...
							if ($eliminar==1)
								...
								echo"<img src='imagenes/icoeliminar.gif' width='16' alt='Eliminar Registro' height='16' style='cursor:pointer' onclick=confirmar($db->cod_rso) /></td> ";
