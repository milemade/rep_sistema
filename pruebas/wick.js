...
//.replace(/[Å½,Â,Â,â??,\u00E9,\u00E8,\u00EA,\u00EB]/gi,"e").replace(/[Ë?,â?°,\u00E0,\u00E2]/gi,"a").
}//simplify
...
if (document.addEventListener) { //agerga  eventos a fire fox
	document.addEventListener("keydown", handleKeyDown, false);
	document.addEventListener("keyup", handleKeyPress, false);
	document.addEventListener("mouseup", handleClick, false);
	document.addEventListener("mouseover", handleMouseOver, false);
	
} else { //agerga eventoa a explorer
...
//crea una tabla donde muesta los resultado
document.write (
'<table id="smartInputFloater" class="floater" cellpadding="0" cellspacing="0" border ="2"><tr><td id="smartInputFloaterContent" nowrap="nowrap">'
+'<\/td><\/tr><\/table>'
);
