...
if(!empty($busquedas)) { 
	...
	$where=" where $busquedas and cod_bod > 0";

}

else{

	$where=" where   cod_bod > 0";

}



$sql="SELECT * FROM bodega1 $where order by nom_bod";
                      ...
                      <td bgcolor="#E9E9E9"><table width="624" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
						  ...
						  <? if ($insertar==1) {?>
					  	  ...
					  	  <img src="imagenes/page.png" width="16" height="16"  alt="Nuevo Registro" style="cursor:pointer" onClick="location.href='man_bodegas.php?codigo=0&editar=<?=$editar?>&insertar=<?=$insertar?>&eliminar=<?=$eliminar?>'"/>
                          ...
                          <td width="160" class="ctablaform"><select name="campos" class="textfieldlista" id="campos" >
                           ...
                           <option value="0">Seleccion</option>
							...
							<option value="iden_bod">Codigo</option>
