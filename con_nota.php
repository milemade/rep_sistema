...
if($eliminacion==1) {//confirmacion de insercion  
	$error=eliminar("nota",$eli_codigo,"cod_bod");
	if ($error >=1)
...
<tr>
<td valign="top" >
<form id="forma_total" name="forma_total" method="post" action="man_nota.php">
                    ...
                    <tr>
                      <td bgcolor="#E9E9E9"><table width="624" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="19"> 
						  <? if ($insertar==1) {?>
					  	  <img src="imagenes/page.png" width="16" height="16"  alt="Nuevo Registro" style="cursor:pointer" onClick="location.href='man_nota.php?codigo=0&editar=<?=$editar?>&insertar=<?=$insertar?>&eliminar=<?=$eliminar?>'"/>
					  	  <? } ?></td>
                    ...
                    <tr>
                      <td><table width="624" border="0"  cellpadding="0">
                        <tr>
						  ...
						  <td  class="ctablasup">DETALLE </td>
                          <td  class="ctablasup"  width="112">OPCIONES</td>
                        </tr>
						<? 
						
						echo "<tr style='display:none'><td ><form name='forma_0' action='man_nota.php'>";
						echo "  </form> </td></tr>  ";						  
						$estilo="ctablablanc";
						$estilo="ctablagris";
						...
						while($db->next_row()) {
							...
							echo "<tr class='$estilo' $cambio_celda> <form name='forma_$db->cod_bod' action='man_nota.php'>  ";
                          	echo "<td >$db->cod_not</td>";
							echo "<td >$db->fec_not</td>";
							echo "<td  align='right'>".number_format($db->val_not,0,",",".")."</td>"; 
							echo "<td >$db->obs_not </td>";
...
<form name="forma" method="post" action="con_nota.php">
