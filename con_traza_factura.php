...
function abrir() {		
...

	{
		...
		imprimir_inf("consulta_facturacion_traza.php",cliente+'&fec_ini='+fec_ini+'&fec_fin='+fec_fin,'mediano');
...
<form id="forma_total" name="forma_total" method="post" action="formatos/ver_traza.php">
                  ...
                  <table width="624" border="0" cellspacing="0" cellpadding="0" align="center" >
                    ...
                    <tr>
                      ...
                      <td><table width="625" border="0"  cellpadding="0" align="center">

                        <tr>

                          <td colspan="6"  class="ctablasup" >CONSULTA FACTURACION </td>

                          <td  class="ctablasup"  width="51">INFORME</td>
                        ...
                        <tr>
                          ...
                          <td width="74" class="ctablablanc" >Cliente</td>

                          <td width="75" class="ctablablanc" >

						  <? 

		

		$sql=" SELECT DISTINCT ( m_factura.cod_cli) as cod_cli,  bodega1.nom_bod  FROM   cartera_factura   INNER JOIN m_factura ON (cartera_factura.cod_fac = m_factura.cod_fac)   INNER JOIN bodega1 ON (m_factura.cod_cli = bodega1.cod_bod)  order by nom_bod ";

		

		 combo_sql("cliente","bodega1","cod_cli","nom_bod","",$sql); 

		?></td>

                          <td width="40" class="ctablablanc" >Fecha Inicial</td>

                          <td width="149" class="ctablablanc" >
                          ...
                          <td width="42" class="ctablablanc" >Fecha Final </td>

                          <td width="158" class="ctablablanc" >
