...
<? 
$cantidad_paginas=paginar("SELECT cod_usu, nom_usu AS usuario , des_car FROM usuario INNER JOIN  cargo  ON usuario.car_usu=cargo.cod_car  ORDER BY  usuario ");
                  ...
                  <table width="624" border="0" cellspacing="0" cellpadding="0" align="center" >
                    ...
                    <tr>
                      ...
                      <td><table width="624" border="0"  cellpadding="0">
						...
						$sql="SELECT cod_usu, nom_usu AS usuario FROM usuario  ORDER BY  nom_usu  $paginar";
