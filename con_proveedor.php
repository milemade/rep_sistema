...
if($eliminacion==1) {//confirmacion de eliminacion 
	$error=eliminar("proveedor",$eli_codigo,"cod_pro");
	if ($error >=1)
...
<table align="center">
  ...
  <tr>
    ...
    <td valign="top" ><form action="ficheroExcel.php" method="post" target="_blank" id="FormularioExportacion">
...
<input type="hidden" id="datos_a_enviar" name="datos_a_enviar" />
...
</form><form id="forma_total" name="forma_total" method="post" action="man_proveedor.php">
      ...
      <table width="624" border="0" cellspacing="0" cellpadding="0" align="center" >
          ...
          <td bgcolor="#E9E9E9"><table width="624" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td width="17"><? if ($insertar==1) {?>
                      ...
                      <img src="imagenes/page.png" width="16" height="16"  alt="Nuevo Registro" style="cursor:pointer" onClick="location.href='man_proveedor.php?codigo=0&editar=<?=$editar?>&insertar=<?=$insertar?>&eliminar=<?=$eliminar?>'"/>
        ...
        <tr>
          ...
          <td><table width="624" border="0" cellspacing="0" bordercolor="#666666" id="Exportar_a_Excel" style="border-collapse:collapse;">
