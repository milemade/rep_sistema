...
$sql="SELECT cod_mar,nom_mar,desc_mar FROM marca  $where";
                      ...
                      <td bgcolor="#E9E9E9"><table width="624" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
						  ...
						  <? if ($insertar==1) {?>
					  	  ...
					  	  <img src="imagenes/page.png" width="16" height="16"  alt="Nuevo Registro" style="cursor:pointer" onClick="location.href='man_marca.php?codigo=0&editar=<?=$editar?>&insertar=<?=$insertar?>&eliminar=<?=$eliminar?>'"/>
                          ...
                          <td width="160" valign="middle"><select name="campos" class="textfieldlista" id="campos" >
                            ...
                            <option value="desc_mar">Descripción</option>
                      ...
                      <td><table width="624" border="0"  cellpadding="0">
						...
						while($db->next_row()) {
							...
							if ($editar==1)
							 	...
							 	echo "<img src='imagenes/icoeditar.gif' alt='Editar Registro' width='16' height='16' style='cursor:pointer'  onclick='document.forma_$db->cod_mar.submit()'/></td>";
							...
							if ($eliminar==1)
								...
								echo"<img src='imagenes/icoeliminar.gif' width='16' alt='Eliminar Registro' height='16' style='cursor:pointer' onclick=confirmar($db->cod_mar) /></td> ";
