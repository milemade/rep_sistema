...
if($eliminacion==1) {//confirmacion de insercion  
	$error=eliminar("tercero",$eli_codigo,"cod_ter");
	if ($error >=1)
...
$cantidad_paginas=paginar("SELECT  cod_usu,concat(nom_usu,concat('  ',ape_usu))AS usuario ,des_car  ,nom_pro FROM usuario INNER JOIN cargo  ON cod_car=car_usu INNER JOIN proyecto ON cod_pro=cod_pro_usu $where   ORDER BY nom_pro , des_car, usuario ");
                      ...
                      <td bgcolor="#E9E9E9"><table width="624" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="160" valign="middle"><select name="campos" class="textfieldlista" id="campos" >
							...
							<option value="des_car">Cargo</option>
							<option value="nom_pro">Proyecto</option>
                    ...
                    <tr>
                      <td><table width="624" border="0"  cellpadding="0">
                        <tr>
						  ...
						  <td  class="ctablasup">PROYECTO </td>
						...
						$estilo="ctablablanc";
						$estilo="ctablagris";
						$sql=" SELECT  cod_usu,concat(nom_usu,concat('  ',ape_usu))AS usuario ,des_car  ,nom_pro FROM usuario INNER JOIN cargo  ON cod_car=car_usu INNER JOIN proyecto ON cod_pro=cod_pro_usu $where ORDER BY nom_pro , des_car, usuario  $paginar";
						//echo $sql;
						...
						while($db->next_row()) {
                            ...
                            echo 	" <tr>  <td align='center'> <input type='text' name='codigo' value='$db->cod_usu'>";
							if ($editar==1)
							 	echo "<img src='imagenes/icoeditar.gif' alt='Editar Registro' width='16' height='16' style='cursor:pointer'  onclick='document.forma_$db->cod_ter.submit()'/></td>";
							else 
