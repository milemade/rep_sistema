...
function abrir() {		
...

	{
		...
		imprimir_inf("com_pagos_inf.php",'0&fec_ini='+fec_ini+'&fec_fin='+fec_fin+'&proveedor='+proveedor,'mediano');
...
<form id="forma_total" name="forma_total" method="post" action="formatos/ver_traza.php">
                  ...
                  <table width="654" border="0" cellspacing="0" cellpadding="0" align="center" >
                    ...
                    <tr>
                      ...
                      <td><table width="613" border="0"  cellpadding="0" align="center">

                        <tr>

                          <td colspan="4"  class="ctablasup" >INFORME DE PAGOS </td>

                          <td  class="ctablasup"  width="178">INFORME</td>
                        ...
                        <tr>
                          ...
                          <td width="103" class="ctablablanc" >Fecha Inicial </td>

                          <td width="162" class="ctablablanc" >
                          ...
                          <td width="78" class="ctablablanc" >Fecha Final </td>

                          <td width="163" class="ctablablanc" >
